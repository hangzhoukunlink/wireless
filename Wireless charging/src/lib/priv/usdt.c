...
#elif CONFIG_PDI_SDM30
static const can_msg_t req_flow_msg = {
	.id = 0x247,
	.dlc = 8,
	.data = {0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
};
#elif CONFIG_PDI_CMF1
static const can_msg_t req_flow_msg = {
	.id = 0x752,
	.dlc = 8,
	.data = {0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
#elif CONFIG_PDI_KC
static can_msg_t req_flow_msg = {
	.id = 0x607,
	.dlc = 8,
	.data = {0x30, 0x00, 0x00, 0x55, 0x55, 0x55, 0x55, 0x55},
};
#elif CONFIG_PDI_CHB041
static can_msg_t req_flow_msg = {
	.id = 0x780,
	.dlc = 8,
	.data = {0x30, 0x00, 0x00, 0x55, 0x55, 0x55, 0x55, 0x55},

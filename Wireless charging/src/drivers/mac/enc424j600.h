...
// Receive Status Vector bit fields
	...
	////////////////////////////////////////////////////
	#define RCR1 		(0x0u<<5)// Read Control Register
...
////////////////////////////////////////////////////
// ESTAT bits ----------
#define ESTAT_INT		((int)1<<15)
#define ESTAT_FCIDLE	((int)1<<14)
#define ESTAT_RXBUSY	((int)1<<13)
#define ESTAT_CLKRDY	((int)1<<12)
#define ESTAT_RSTDONE	((int)1<<11)
#define ESTAT_PHYDPX	((int)1<<10)
#define ESTAT_PHYRDY	((int)1<<9)
#define ESTAT_PHYLNK	((int)1<<8)
...
// EIR bits ------------
#define EIR_CRYPTEN		((int)1<<15)
#define EIR_MODEXIF		((int)1<<14)
#define EIR_HASHIF		((int)1<<13)
#define EIR_AESIF		((int)1<<12)
#define EIR_LINKIF		((int)1<<11)
#define EIR_PRDYIF		((int)1<<10)
#define EIR_r9			((int)1<<9)
#define EIR_r8			((int)1<<8)
#define EIR_r7			(1<<7)
...
// ECON1 bits ----------
#define ECON1_MODEXST	((int)1<<15)
#define ECON1_HASHEN	((int)1<<14)
#define ECON1_HASHOP	((int)1<<13)
#define ECON1_HASHLST	((int)1<<12)
#define ECON1_AESST		((int)1<<11)
#define ECON1_AESOP1	((int)1<<10)
#define ECON1_AESOP0	((int)1<<9)
#define ECON1_PKTDEC	((int)1<<8)
...
// ETXSTAT bits --------
#define ETXSTAT_r12		((int)1<<12)
#define ETXSTAT_r11		((int)1<<11)
#define ETXSTAT_LATECOL	((int)1<<10)
#define ETXSTAT_MAXCOL	((int)1<<9)
#define ETXSTAT_EXDEFER	((int)1<<8)
...
// ERXFCON bits --------
#define ERXFCON_HTEN	((int)1<<15)
#define ERXFCON_MPEN	((int)1<<14)
#define ERXFCON_NOTPM	((int)1<<12)
#define ERXFCON_PMEN3	((int)1<<11)
#define ERXFCON_PMEN2	((int)1<<10)
#define ERXFCON_PMEN1	((int)1<<9)
#define ERXFCON_PMEN0	((int)1<<8)
...
// MACON1 bits ---------
#define MACON1_r15		((int)1<<15)
#define MACON1_r14		((int)1<<14)
#define MACON1_r11		((int)1<<11)
#define MACON1_r10		((int)1<<10)
#define MACON1_r9		((int)1<<9)
#define MACON1_r8		((int)1<<8)
...
// MACON2 bits ---------
#define	MACON2_DEFER	((int)1<<14)
#define	MACON2_BPEN		((int)1<<13)
#define	MACON2_NOBKOFF	((int)1<<12)
#define MACON2_r9		((int)1<<9)
#define MACON2_r8		((int)1<<8)
...
// MAIPG bits ----------
#define MAIPG_r14		((int)1<<14)
#define MAIPG_r13		((int)1<<13)
#define MAIPG_r12		((int)1<<12)
#define MAIPG_r11		((int)1<<11)
#define MAIPG_r10		((int)1<<10)
#define MAIPG_r9		((int)1<<9)
#define MAIPG_r8		((int)1<<8)
...
// MACLCON bits --------
#define MACLCON_r13		((int)1<<13)
#define MACLCON_r12		((int)1<<12)
#define MACLCON_r11		((int)1<<11)
#define MACLCON_r10		((int)1<<10)
#define MACLCON_r9		((int)1<<9)
#define MACLCON_r8		((int)1<<8)
...
// MIREGADR bits -------
#define MIREGADR_r12	((int)1<<12)
#define MIREGADR_r11	((int)1<<11)
#define MIREGADR_r10	((int)1<<10)
#define MIREGADR_r9		((int)1<<9)
#define MIREGADR_r8		((int)1<<8)
...
// ECON2 bits ----------
#define ECON2_ETHEN		((int)1<<15)
#define ECON2_STRCH		((int)1<<14)
#define ECON2_TXMAC		((int)1<<13)
#define ECON2_SHA1MD5	((int)1<<12)
#define ECON2_COCON3	((int)1<<11)
#define ECON2_COCON2	((int)1<<10)
#define ECON2_COCON1	((int)1<<9)
#define ECON2_COCON0	((int)1<<8)
...
// ERXWM bits ----------
#define ERXWM_RXFWM7	((int)1<<15)
#define ERXWM_RXFWM6	((int)1<<14)
#define ERXWM_RXFWM5	((int)1<<13)
#define ERXWM_RXFWM4	((int)1<<12)
#define ERXWM_RXFWM3	((int)1<<11)
#define ERXWM_RXFWM2	((int)1<<10)
#define ERXWM_RXFWM1	((int)1<<9)
#define ERXWM_RXFWM0	((int)1<<8)
...
// EIE bits ------------
#define EIE_INTIE		((int)1<<15)
#define EIE_MODEXIE		((int)1<<14)
#define EIE_HASHIE		((int)1<<13)
#define EIE_AESIE		((int)1<<12)
#define EIE_LINKIE		((int)1<<11)
#define EIE_PRDYIE		((int)1<<10)
#define EIE_r9			((int)1<<9)
#define EIE_r8			((int)1<<8)
#define EIE_r7			(1<<7)
...
// EIDLED bits ---------
#define EIDLED_LACFG3	((int)1<<15)
#define EIDLED_LACFG2	((int)1<<14)
#define EIDLED_LACFG1	((int)1<<13)
#define EIDLED_LACFG0	((int)1<<12)
#define EIDLED_LBCFG3	((int)1<<11)
#define EIDLED_LBCFG2	((int)1<<10)
#define EIDLED_LBCFG1	((int)1<<9)
#define EIDLED_LBCFG0	((int)1<<8)
...
// PHCON1 bits ---------
#define PHCON1_PRST		((int)1<<15)
#define PHCON1_PLOOPBK	((int)1<<14)
#define PHCON1_SPD100	((int)1<<13)
#define PHCON1_ANEN		((int)1<<12)
#define PHCON1_PSLEEP	((int)1<<11)
#define PHCON1_r10		((int)1<<10)
#define PHCON1_RENEG	((int)1<<9)
#define PHCON1_PFULDPX	((int)1<<8)
...
// PHSTAT1 bits --------
#define PHSTAT1_r15		((int)1<<15)
#define PHSTAT1_FULL100	((int)1<<14)
#define PHSTAT1_HALF100	((int)1<<13)
#define PHSTAT1_FULL10	((int)1<<12)
#define PHSTAT1_HALF10	((int)1<<11)
#define PHSTAT1_r10		((int)1<<10)
#define PHSTAT1_r9		((int)1<<9)
#define PHSTAT1_r8		((int)1<<8)
...
// PHANA bits ----------
#define PHANA_ADNP		((int)1<<15)
#define PHANA_r14		((int)1<<14)
#define PHANA_ADFAULT	((int)1<<13)
#define PHANA_r12		((int)1<<12)
#define PHANA_ADPAUS1	((int)1<<11)
#define PHANA_ADPAUS0	((int)1<<10)
#define PHANA_r9		((int)1<<9)
#define PHANA_AD100FD	((int)1<<8)
...
// PHANLPA bits --------
#define PHANLPA_LPNP	((int)1<<15)
#define PHANLPA_LPACK	((int)1<<14)
#define PHANLPA_LPFAULT	((int)1<<13)
#define PHANLPA_r12		((int)1<<12)
#define PHANLPA_LPPAUS1	((int)1<<11)
#define PHANLPA_LPPAUS0	((int)1<<10)
#define PHANLPA_LP100T4	((int)1<<9)
#define PHANLPA_LP100FD	((int)1<<8)
...
// PHANE bits ----------
#define PHANE_r15		((int)1<<15)
#define PHANE_r14		((int)1<<14)
#define PHANE_r13		((int)1<<13)
#define PHANE_r12		((int)1<<12)
#define PHANE_r11		((int)1<<11)
#define PHANE_r10		((int)1<<10)
#define PHANE_r9		((int)1<<9)
#define PHANE_r8		((int)1<<8)
#define PHANE_r7		(1<<7)
#define PHANE_r6		(1<<6)
#define PHANE_r5		(1<<5)
...
// PHCON2 bits ---------
#define PHCON2_r15		((int)1<<15)
#define PHCON2_r14		((int)1<<14)
#define PHCON2_EDPWRDN	((int)1<<13)
#define PHCON2_r12		((int)1<<12)
#define PHCON2_EDTHRES	((int)1<<11)
#define PHCON2_r10		((int)1<<10)
#define PHCON2_r9		((int)1<<9)
#define PHCON2_r8		((int)1<<8)
...
// PHSTAT2 bits ---------
#define PHSTAT2_r15		((int)1<<15)
#define PHSTAT2_r14		((int)1<<14)
#define PHSTAT2_r13		((int)1<<13)
#define PHSTAT2_r12		((int)1<<12)
#define PHSTAT2_r11		((int)1<<11)
#define PHSTAT2_r10		((int)1<<10)
#define PHSTAT2_r9		((int)1<<9)
#define PHSTAT2_r8		((int)1<<8)
...
// PHSTAT3 bits --------
#define PHSTAT3_r15		((int)1<<15)
#define PHSTAT3_r14		((int)1<<14)
#define PHSTAT3_r13		((int)1<<13)
#define PHSTAT3_r12		((int)1<<12)
#define PHSTAT3_r11		((int)1<<11)
#define PHSTAT3_r10		((int)1<<10)
#define PHSTAT3_r9		((int)1<<9)
#define PHSTAT3_r8		((int)1<<8)

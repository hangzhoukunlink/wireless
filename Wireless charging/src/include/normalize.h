...
#define NOR_RES(x) (int)(x / NOR_RES_VAL * midShort) /*y =  (x/nor_res)*32768*/
#define _RES(y) ((float)y * NOR_RES_VAL / midShort) /* res= (y/32768)*nor_res */

#define NOR_IND_VAL	(1 << 10)/*unit: mH*/
#define NOR_IND(x) (int)(x / NOR_IND_VAL * midShort) /*y =  (x/nor_ind)*32768*/
#define _IND(y) ((float)y * NOR_IND_VAL / midShort) /* ind= (y/32768)*nor_ind */
